...
from .models.bricks.relation_transformer import PositionRelationEmbedding
...
class TransformerDecoder(nn.Module):
    ...
    def __init__(self, hidden_dim, decoder_layer, decoder_layer_wide, num_layers, num_head, reg_max, reg_scale, up,
        ...
        self.position_relation_embedding = PositionRelationEmbedding(32, self.num_head)
    ...
    def forward(self,
        ...
        for i, layer in enumerate(self.layers):
            ...
            output = layer(output, ref_points_input, value, spatial_shapes, pos_relation, query_pos_embed)
            ...
            src_boxes_r = tgt_boxes_r if i >= 1 else ref_points_detach
            tgt_boxes_r = inter_ref_bbox  
            pos_relation = self.position_relation_embedding(src_boxes_r, tgt_boxes_r).flatten(0, 1)
